...
<div class="aboutus">
    ...
    <img src="/dev.acfw.com/img/studentsspeakout.png" alt="students speakout image">
    ...
    <ul class="a">
        <li>Share your thoughts freely: Post anonymously about anything that's on your mind.</li>
        <li>Connect with others: Engage in anonymous discussions and build community.</li>
        <li>Inspire and be inspired: Discover new ideas and perspectives from your peers.</li>
    </ul>
    ...
    <img src="/dev.acfw.com/img/speakout.jpg" alt="speech bubble">
