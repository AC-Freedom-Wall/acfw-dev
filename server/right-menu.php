<div class="right-menu">
        ...
        <?php
			...
			<br> <br> <a href="server/member/logout.php">Logout</a> <br>
				<?php
			...
			<?php }else{ ?><!--세션 userid체크해서 세션값 없으면 로그인 폼 표시 -->
				<form class="login-form" action="server/member/login_ok.php" method="post">
					<ul>
            ...
            <li><button onclick="location.href='server/member/join_form.php'">Registration</button></li>
          </ul>
				</form>
			<?php } ?>
